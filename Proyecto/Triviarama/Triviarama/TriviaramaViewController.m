...
//se inicializa la animacion gif y se establace el backgorund
- (void)viewDidLoad {
    [super viewDidLoad];
...
//se hace segue al controlador FARM en caso de que se tenga acceso a internet
- (IBAction)farmSegue:(id)sender {
    if ([Reachability connected]) {
    FARMViewController *myController = [self.storyboard instantiateViewControllerWithIdentifier:@"farm"];
